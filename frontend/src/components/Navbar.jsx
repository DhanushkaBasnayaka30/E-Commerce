				...
				<div className="flex items-center gap-6 ">
					...
					<div className="group relative">
						<img
							...
							alt=""
						/>
						<div className="group-hover:block hidden absolute dropdown-menu left-[-50px] m-auto pt-4">
					...
					<div className=" relative">
						<Link to="/cart">
							...
							<p className="absolute w-5 text-sm text-white leading-4  right-[-10px] bottom-[-8px] bg-gray-900 rounded-full">
								10
							</p>
						</Link>
					</div>
