  ...
  const handleSubmit=(event)=>{
	...
	return (
        ...
        <p className="text-gray-400 mt-3">
          ...
          <div className="w-[70%] mx-auto h-12 px-2 mt-8">

          <form onSubmit={handleSubmit} className="   sm:w-3/4  mx-auto flex border  items-center my-6  ">
            <input required type="email" placeholder=" Enter You Email" className ="w-3/4 border h-[48px] border-gray-300 outline-none  md:w-full  "name="" id="" />
